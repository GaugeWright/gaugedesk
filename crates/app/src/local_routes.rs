...
pub fn routes(federation_on: bool) -> Router<SharedWorkbench> {
    let routes = Router::new()
        ...
        .route(
            "/chats/{id}/file-actions/content",
            get(crate::file_action_routes::inspect_native_content).layer(
        ...
        .route(
            "/projects/{project}/trackers/{queue}/issues",
            get(crate::project_tracker_routes::read_backlog),
        )
        .route(
            "/projects/{project}/trackers/{queue}/tasks",
            get(crate::project_tracker_routes::read_tasks),
        )
        .route(
            "/projects/{project}/trackers/{queue}/issues/{item_id}/complete",
        ...
        .route(
            "/chats/{chat}/whips/run",
            post(crate::project_workflow_routes::run_chat_whip),
        )
        .route(
