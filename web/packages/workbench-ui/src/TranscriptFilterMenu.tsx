/**
 * The transcript **filter** panel inside the chat options menu. You can hide each message
...
export function TranscriptFilterMenu(props: {
    ...
    return (
        <div class="filter-panel" data-transcript-filter-menu>
            <button type="button" class="filter-back" data-filter-back onClick={props.onBack}>
                ‹ Chat menu
            </button>
